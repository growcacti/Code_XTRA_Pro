...
class CodeEditorApp:
    ...
    def create_widgets(self):
        tk.Label(self.parent,text = "Insert word").grid(row=0, column=0)
        self.entry = tk.Entry(self.parent)
        self.entry.grid(row=1, column=0)
        self.lbox = tk.Listbox(self.parent,  selectmode='multiple')
        self.lbox.grid(row=2, column=0, padx=10, pady=10, sticky="ew")
        ...
        self.info = TextWidgetInfo(self.parent, self.textwidget)
