...
class MenuBar(tk.Menu):
    def __init__(self, parent):
       ...
       # Buttons frame
        ...
        self.notebook.add(self.frm10, text="10")
        ...
        self.subnote.bind("<<NotebookTabChanged>>", self.ontab_subnote)                                    
...
##        self.textwidget.bind('<KeyRelease>', lambda event: self.highlight_syntax()) 
    ...
    def ontab_subnote(self, event=None):
        self.selected_index = self.subnote.index(self.subnote.select())
    ...
    def ontab_notebook(self, event=None):
        ...
        if self.selected_index == 0:
            ...
            self.textwidget = self.autopep8.wtext
        print(self.selected_index)
    ...
    def read_file_and_remove_duplicates(self):
        ...
        fontbar = FontBar(self.parent,self.textwidget)
##    def debounce_highlight_syntax(self, textwidget):
##        if self.highlight_debounce_timer:
##            self.highlight_debounce_timer.cancel()
##        self.highlight_debounce_timer = threading.Timer(0.5, lambda: self.highlight_syntax(textwidget))
